...
def main():
    ...
    net = DVSNet_Channel_fisher.DVSGestureNet(channels=args.channels, spiking_neuron=neuron.LIFNode,
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        #                           epoch, save_dir=f'fisher_vs_fsr/',
