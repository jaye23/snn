...
import DVSNet_Channel_LessNeurons
...
def main():
    ...
    net = DVSNet_Channel_LessNeurons.DVSGestureNet(channels=args.channels, spiking_neuron=neuron.LIFNode, surrogate_function=surrogate.ATan(), detach_reset=True,PDP=PDP,snr=args.snr,device=args.device)
    ...
    plt.tight_layout()
    plt.savefig(
        f'acc_snr_{args.snr}_channel_lessNeurons.png')
    plt.show()
